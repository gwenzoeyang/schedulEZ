---
timestamp: 'Sun Oct 19 2025 08:06:41 GMT-0400 (Eastern Daylight Time)'
content_id: be3f882c2711abf87adcfc63edb35689516efd0449612d639c5bd0f5979e39dc
---
...
export class RequirementTracker {
  ...
  recompute(owner: User, courses: Set<Course>): void {
    ...
    // Get definitive list of applicable requirements from the rules system
    const reqs = this.rules.allRequirementsFor(owner);
    ...
    for (const key of [...current.keys()]) {
      const stillApplies = reqs.some((r) => reqKey(r) === key);
      if (!stillApplies) current.delete(key);
    }
  }
