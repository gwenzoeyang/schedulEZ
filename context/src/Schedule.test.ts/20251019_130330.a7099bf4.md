---
timestamp: 'Sun Oct 19 2025 13:03:30 GMT-0400 (Eastern Daylight Time)'
content_id: a7099bf4c172b880efedd9ddf6fcaebbf0d22f29f61ce186649a3bec4b28d044
---
...
Deno.test("Schedule.updateAfterAddAI throws if prefs missing or course not present", async () => {
  ...
  await Promise.resolve().then(async () => {
    await assertThrows(
      async () => await sch.updateAfterAddAI(user, C1),
      Error,
