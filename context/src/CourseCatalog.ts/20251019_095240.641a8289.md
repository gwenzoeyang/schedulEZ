---
timestamp: 'Sun Oct 19 2025 09:52:40 GMT-0400 (Eastern Daylight Time)'
content_id: 641a8289aa29fe44e5e373b02b24766dd9b9d262b56318e15fdc8b22b7979855
---
...
function adaptCourse(dbRow: CourseDB): Course {
  ...
  for (const time of dbRow.meetingTimes) {
    ...
    const start = parts[1];
    const end = parts[2];
    for (const day in day_s) {
      let temp_time: TimeSlot = { day, start, end };
...
export class CourseCatalog {
  ...
  search(query?: string, filters: CourseFilters = {}): Set<Course> {
    ...
    for (const c of this.all) {
      ...
      // (Removed) campus filter — no longer considered
